...
class DecoderHead(nn.Module):
    ...
    def forward(self, rgb,depth):
        ...
        print("Decoder: MLPDecoderaddition")
        ...
        #  _c_r = self.linear_fuse_rgb(torch.cat([_c4_r, _c3_r, _c2_r, _c1_r], dim=1))  #original version
        _c_r = self.linear_fuse_rgb(torch.cat([_c4_r+_c4_d, _c3_r+_c3_d, _c2_r+_c2_d, _c1_r+_c1_d], dim=1))
